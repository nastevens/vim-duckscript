...
syntax match duckKeyword display contained "\v<%(get_cpu_count|current_time|dirname|duckscript_sdk_version)>"
...
syntax match duckKeyword display contained "\v<%(print_env|printenv|pwd|print_current_directory|random_range)>"
...
syntax match duckKeyword display contained "\v<%(set_add|set_remove|set_size|set_to_array|sleep|snakecase)>"
syntax match duckKeyword display contained "\v<%(spawn|split|starts_with|string_to_bytes|substring|temp_dir)>"
syntax match duckKeyword display contained "\v<%(temp_file|test_directory|test_file|touch|trigger_error|trim)>"
syntax match duckKeyword display contained "\v<%(trim_end|trim_start|unalias|uname|unset|unset_all_vars)>"
syntax match duckKeyword display contained "\v<%(unset_env|uppercase|watchdog|wget|which|while|whoami)>"
