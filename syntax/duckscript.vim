...
syntax match duckKeyword display contained "\v<%(is_set|is_windows|json_encode|json_parse|last_indexof)>"
...
syntax match duckKeyword display contained "\v<%(printenv|pwd|print_current_directory|range|read|readbinfile)>"
...
syntax match duckKeyword display contained "\v<%(scope_push_stack|set|set_by_name|set_clear|set_contains)>"
syntax match duckKeyword display contained "\v<%(set_env|set_error|set_from_array|set_is_empty|set_new)>"
syntax match duckKeyword display contained "\v<%(set_put|set_add|set_remove|set_size|set_to_array|sleep)>"
