...
syntax match duckKeyword display contained "\v<%(globarray|glob_chmod|goto|greater_than|hex_decode)>"
syntax match duckKeyword display contained "\v<%(hex_encode|hostname|http_client|if|indexof|is_array)>"
syntax match duckKeyword display contained "\v<%(is_command_defined|is_directory|is_dir|is_empty|is_file)>"
syntax match duckKeyword display contained "\v<%(is_map|is_path_exists|is_path_newer|is_readonly|is_set)>"
syntax match duckKeyword display contained "\v<%(is_windows|json_encode|json_parse|last_indexof|length)>"
syntax match duckKeyword display contained "\v<%(strlen|less_than|ls|man|map|map_clear|map_contains_key)>"
